...
public class ProductVo {
	...
	public ProductVo(int idx, String category, String p_num, String p_name, String p_company, int p_price,
			int p_saleprice, String p_content) {
		super();
		this.idx = idx;
		this.category = category;
		this.p_num = p_num;
	...
	public int getDiscount_rate() {
		...
		discount_rate = (int)((double)(p_price-p_saleprice)/p_price * 100);
