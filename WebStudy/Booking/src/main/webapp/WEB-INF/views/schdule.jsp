...
<%-- <script type="text/javascript" src="${ pageContext.request.contextPath }/resources/js/calendarSchdule.js"></script> --%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class='form-margin40' role='form' action="#" method='post'
                        id='frmSchdule'>
                        <input type="hidden" name="calendarId" value="${ param.calendarId }">
